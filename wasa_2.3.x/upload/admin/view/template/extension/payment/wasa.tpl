		  ...
		  <div class="tab-content">
		    <div class="tab-pane active" id="tab-settings">
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-10">
                  <input type="text" name="wasa_client_id" value="<?php echo $wasa_client_id; ?>" placeholder="<?php echo $entry_api_key; ?>" id="input-wasa_client_id" class="form-control" />
                  </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="wasa_status" id="input-status" class="form-control">
                    <?php if ($wasa_status) { ?>
                    <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                    <option value="0"><?php echo $text_disabled; ?></option>
                    <?php } else { ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="wasa_order_status_id" id="input-order-status" class="form-control">
                    <?php foreach ($order_statuses as $order_status) { ?>
                    <?php if ($order_status['order_status_id'] == $wasa_order_status_id) { ?>
